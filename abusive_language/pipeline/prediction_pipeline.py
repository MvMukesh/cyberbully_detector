...
from abusive_language.configuration.gcloud_syncer import GCloudSync
from abusive_language.components.data_transformation import DataTransformation
from abusive_language.entity.config_entity import DataTransformationConfig
    ...
    def predict(self,best_model_path,text):
        ...
        try:
            ...
            if pred>0.3:
                ...
                print("abusive_language and abusive")
                return "abusive_language and abusive"
            else:
                print("no abusive_language")
                return "no abusive_language"
        except Exception as e:
            raise CustomException(e, sys) from e
